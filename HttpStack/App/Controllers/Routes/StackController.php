...
class StackController
{
    public function index($req, $res, $container, $matches)
    {
        ...
        // then call the stack method to render the stack view
        // this is a good place to do some initial logic for the stack page
    ...
    protected function stack($req, $res, $container, $matches)
    {
