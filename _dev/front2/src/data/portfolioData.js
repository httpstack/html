const { Github, Linkedin, Mail, FileText, Monitor, Code, Briefcase, Server, ExternalLink, Download, Phone, MapPin, LogIn, Lock } = {
  ...
  Download: (props) => <svg {...props} xmlns="http://www.w.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>,
...
const skillsData = {
  technical: [
    { name: 'Network Administration', level: 'Expert', years: '25+' },
    { name: 'System Troubleshooting', level: 'Expert', years: '25+' },
    { name: 'Hardware Repair', level: 'Expert', years: '25+' },
    { name: 'Windows Server', level: 'Advanced', years: '20+' },
    { name: 'Linux Administration', level: 'Advanced', years: '15+' },
    { name: 'Cisco Networking', level: 'Advanced', years: '18+' },
    { name: 'Active Directory', level: 'Advanced', years: '15+' },
    { name: 'VMware/Hyper-V', level: 'Intermediate', years: '10+' }
  ],
  programming: [
    { name: 'PHP', level: 'Intermediate', years: '3+' },
    { name: 'JavaScript', level: 'Intermediate', years: '2+' },
    { name: 'HTML/CSS', level: 'Intermediate', years: '3+' },
    { name: 'SQL', level: 'Intermediate', years: '5+' },
...
const projectsData = [
  {
    ...
    description: 'Complete redesign and implementation of enterprise network infrastructure for 500+ user organization.',
    technologies: ['Cisco', 'Windows Server', 'Active Directory', 'VMware'],
    type: 'Infrastructure',
    year: '2023'
  },
  {
    title: 'Custom PHP Web Application',
    description: 'Built a custom inventory management system using PHP with modern MVC architecture and responsive design.',
    technologies: ['PHP 8', 'MySQL', 'JavaScript', 'Bootstrap'],
    type: 'Development',
    year: '2024'
  },
  {
    title: 'Automated Backup Solution',
    description: 'Designed and implemented automated backup system reducing data recovery time by 80%.',
    technologies: ['PowerShell', 'Windows Server', 'Hyper-V', 'Azure'],
    type: 'Automation',
    year: '2023'
  }
];
...
const resumeFormats = [
  { 
    type: 'PDF', 
    description: 'Standard format for most applications',
    icon: FileText,
    filename: 'resume.pdf'
  },
  { 
